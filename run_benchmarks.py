...
def run_benchmark(
    ...
    #     data = data[data['index'].isin([ 80, 132, 146, 156, 160, 162, 164, 173, 177, 180, 185, 192, 195, 197,
    ...
    #    889, 891, 892, 893, 895, 897, 898] + [ 20,  31,  52,  61,  77,  87,  97, 121, 122, 125, 126, 129, 134, 135,

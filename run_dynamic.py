...
def run_dynamic_benchmark(
    models: Annotated[str, typer.Option(help="Comma-separated list of models to benchmark")] = "gpt-4.1-2025-04-14",
    partner_model: Annotated[str, typer.Option(help="Partner model to use")] = "gpt-4o-2024-08-06",
    experiment_tag: Annotated[str, typer.Option(help="Tag for the benchmark run")] = "social_world_model_trial_22_social_world_model_agent",
    batch_size: Annotated[int, typer.Option(help="Batch size for processing")] = 100,
    push_to_db: Annotated[bool, typer.Option(help="Whether to push results to database")] = True,
    evaluator_model: Annotated[str, typer.Option(help="Model to use for evaluation")] = "o3-2025-04-16",
    task: Annotated[str, typer.Option(help="Task difficulty level")] = "hard",
    agent_type: Annotated[str, typer.Option(help="Type of agent to use (social_world_model or vanilla)")] = "social_world_model",
    social_world_model_name: Annotated[str, typer.Option(help="Name of the social world model to use")] = "gpt-4.1-2025-04-14",
) -> None:
    """Run benchmark with Social World Model agents."""
    # Validate agent_type
    if agent_type not in ["social_world_model", "vanilla"]:
        raise typer.BadParameter("Agent type must be either 'social_world_model' or 'vanilla'")
